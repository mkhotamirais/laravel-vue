...
defineProps({ listings: Object, msg: String });
...
<template>
  ...
  <section class="container">
    <div v-if="listings" class="py-4">
      <SessMsg :msg="msg" />
      <div v-if="Object.keys(listings.data).length">
        <div class="mb-6">
          <!-- Heading -->
          <div class="flex items-center justify-between mb-4">
            <h1 class="h1">Your latest listings</h1>
            <div class="flex items-center gap-4 text-xs">
              <p>
                Approved <i class="fa-solid fa-circle-check text-green-500"></i>
              </p>
              <p>
                Pending approval <i class="fa-solid fa-xmark text-red-500"></i>
              </p>
            </div>
          </div>
          ...
          <!-- Table -->
          <table
            class="w-full table-fixed border-collapse overflow-hidden rounded-md text-sm ring-1 ring-slate-200 dark:ring-slate-600 bg-white shadow-lg"
          >
            <thead
            ...
            >
              <tr>
                ...
                <th class="w-1/4 p-3 pl-0 text-right">View</th>
                <th class="w-1/5 p-3 pl-0 text-right">Edit</th>
                <th class="w-1/5 p-3 pl-0 text-right">Delete</th>
              </tr>
            </thead>
            <tbody>
              <tr
